...
// Le composant s'afficher pour la première fois, la valeur de counter est = 1
// Si je clique sur incrémenter, react va détruire le composant où counter = 1, et va recreer le composant ou counter = 2
...
const Lifecycle = () => {
  ...
  useEffect(() => {
    ...
    if (isFirstRenderRef.current === false) {
      console.log("Ne va s'executer que lors de la mise à jour");
    }
