      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            To access exclusive features and manage your profile, please create an account by
        ...
        >
          ...
          <fieldset className="relative grow w-full">
            <label htmlFor="passwordConfirmation" className="leading-7 text-sm text-gray-600">
              Confirm Password
            </label>
            <input
              type="password"
              ...
              className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
            <p className="text-red-500 text-xs absolute">{errors.passwordConfirmation?.message}</p>
          </fieldset>
